            ...
            <div className="mt-4">
              ...
              {sourceType === 'youtube' && (
                <p className="mt-3 text-sm bg-blue-50 text-blue-700 p-2 rounded-md">
                  ...
                  For YouTube: Upload a CSV file from YouTube Data Tools "Video List" function (<a href="https://ytdt.digitalmethods.net/mod_videos_list.php" target="_blank" rel="noopener noreferrer" className="underline">https://ytdt.digitalmethods.net/mod_videos_list.php</a>) with columns 'videoId', 'channelTitle', 'channelId', 'publishedAt', and your selected object_id source
                </p>
              )}
            </div>
          </div>
